                                ...
                                <?php 
                                    if( current_user_can('edit_transaction') || current_user_can('manage_options')){
                                        echo "<div>";
                                            ...
                                            echo "<a data-target='status' data-post_id={$r->id} data-post_type='{$this->post_type}' data-action='delete' class='edupress-delete-post'  href='javascript:void(0)' data-id='{$r->id}'>".EduPress::getIcon('delete')."</a>";
