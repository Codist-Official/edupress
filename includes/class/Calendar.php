                        ...
                        <tr data-post-id="<?php echo $r->post_id; ?>" >
                            ...
                            <td>
                                ...
                                <?php if(User::currentUserCan('delete', 'calendar')): ?>
                                    <a data-post_type='calendar' data-before_send_callback='deleteCalendarBeforeSendCallback' data-success_callback='deleteCalendarSuccessCallback' data-action='edupress_admin_ajax' data-id='<?php echo $r->post_id; ?>' data-post_id='<?php echo $r->post_id; ?>' data-ajax_action='deleteCalendar' href='javascript:void(0)' class='edupress-ajax edupress-ajax-link'><?php echo EduPress::getIcon('delete'); ?></a>
                                <?php endif; ?>
