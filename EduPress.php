 ...
 */
if( !defined( 'EDUPRESS_VERSION') ) define( 'EDUPRESS_VERSION', '1.5.6' );
...
function t($key, $text_domain = 'edupress'){
    $org_key = $key;
    $active_lang = Admin::getSetting('system_lang', 'en');
...
class EduPress
{
    ...
    public function __construct()
    {
        ...
        // Include class files
        if(__CLASS__ == 'EduPress\\EduPress') $this->includeClassFiles();
