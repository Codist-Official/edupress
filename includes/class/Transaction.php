...
class Transaction extends CustomPost
{
                            ...
                            <td>
                                ...
                                <?php 
                                    if( current_user_can('edit_transaction') || current_user_can('manage_options')){
                                        echo "<div>";
                                            echo "<a data-success_callback='showPopupOnCallback' data-post_id='{$r->id}' data-post_type='{$this->post_type}' class='edit-transaction edupress-ajax edupress-ajax-link' data-ajax_action='getPostEditForm' href='javascript:void(0)' data-id='{$r->id}'>".EduPress::getIcon('edit')."</a>";
                                            ...
                                            echo "<a data-before_send_callback='confirmBeforeSendCallback' data-post_id='{$r->id}' data-post_type='{$this->post_type}' class='sms-transaction edupress-ajax edupress-ajax-link' data-ajax_action='smsTransaction' href='javascript:void(0)' data-id='{$r->id}'>".EduPress::getIcon('sms')."</a>";
                                            echo "<a data-success_callback='printDataOnCallback' data-before_send_callback='confirmBeforeSendCallback' data-post_id='{$r->id}' data-post_type='{$this->post_type}' class='print-transaction edupress-ajax edupress-ajax-link' data-ajax_action='printTransaction' href='javascript:void(0)' data-id='{$r->id}'>".EduPress::getIcon('print')."</a>";
                                        echo "</div>";
                                    }
                                ?>
                            </td>
    ...
    public static function searchUsers( $conds = [] )
    {
        ...
        $args = [];
        $args['role__in'] = !empty($role) ? $role  : array_keys(User::getRoles());
